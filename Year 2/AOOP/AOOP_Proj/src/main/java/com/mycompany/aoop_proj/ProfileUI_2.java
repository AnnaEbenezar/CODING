 ...
 * @author HP
 */
public class ProfileUI_2 extends JFrame {
    ...
    private void button_ProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_ProfileActionPerformed
        ...
        String name = JOptionPane.showInputDialog(this, "Enter Name: ", JOptionPane.INFORMATION_MESSAGE);
        //if (name.equals(JOptionPane.OK_OPTION)) {
        String major = JOptionPane.showInputDialog(this, "What is your Major? ", JOptionPane.INFORMATION_MESSAGE);
        //} 
        String quote = JOptionPane.showInputDialog(this, "Enter your favourite quote!", JOptionPane.INFORMATION_MESSAGE);

        
        
    }//GEN-LAST:event_button_ProfileActionPerformed

    private void jButton_delPGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_delPGActionPerformed
        // TODO add your handling code here:
        jTextField_ipPG.setText(null);
    }//GEN-LAST:event_jButton_delPGActionPerformed

    private void jButton_addPGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_addPGActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jButton_addPGActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfileUI_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfileUI_2().setVisible(true);
            }
        });
    }
